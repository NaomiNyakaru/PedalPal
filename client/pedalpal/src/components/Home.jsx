...
const Home = () => {
  ...
  const handleBrowseBikes = () => {
    navigate("/bikes"); // Redirects to the Bikes page
  };
    ...
    <div>
      <header className="hero">
        <div className="hero-content">
          ...
          <p className="homepage">
            Two wheels, endless possibilities. Cycling: where the journey is
            just as important as the destination. Feel the wind in your face and
            the freedom of the open road.
          </p>
          <button onClick={handleBrowseBikes} className="btn">
            Browse Bikes
          </button>
        </div>
      </header>
      ...
      <section id="categories" className="categories">
        ...
        <div className="category-grid">
          ...
          <div className="category">
            <img
              src="https://images.unsplash.com/photo-1513540870164-07649a1d676f?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Electric Bike"
            />
